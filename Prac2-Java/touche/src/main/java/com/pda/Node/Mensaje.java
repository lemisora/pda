...
public class Mensaje implements Serializable{
    ...
    /**
     * Serializador del Mensaje
     * @param command : tipo de comando a enviar, están definidos en com.pda.Enums.CommandType
     * @param senderId : ID del remitente del mensaje
     * @param senderName : Nombre del remitente del mensaje
     * @param senderHost : IP del remitente del mensaje
     * @param senderPort : Puerto del remitente del mensaje
     * @param data : Contenido del mensaje en forma de String
     */
