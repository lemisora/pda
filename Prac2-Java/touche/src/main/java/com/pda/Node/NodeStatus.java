...
public record NodeStatus(
        ...
        int currentFiles,
        int threshold,
        int availableSlots) implements Serializable {
     ...
     * @param currentFiles : número total de archivos alojados en el nodo al
     *                     momento.
     * @param threshold    : Umbral de máximo de archivos (capacidad) que debe
     *                     almacenar un nodo
     */
