...
public class StorageManager {
     ...
     * @param baseDir : Dirección del directorio donde se almacenarán los directorios que
    ...
    public StorageManager(int threshold, String baseDir) throws IOException {
        ...
        // Mediante createDirectories se crean directorios, si existen no los sobreescribe
